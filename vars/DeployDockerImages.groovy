             ...
             withSonarQubeEnv('SonarQube') {
                 dir("Source/${config.projectName}") {
                   ...
                   // sh "dotnet tool install --global dotnet-sonarscanner"
                    sh " dotnet ${MSBUILD_SQ_SCANNER_HOME}/SonarScanner.MSBuild.dll begin -Dsonar.projectKey=AosoDevops -Dsonar.sources=. -Dsonar.host.url=http://localhost:9000 -Dsonar.login=23b5d4c1c1f76c539f1d0019945228a4003d6a51 "
