         ...
         //def MSBUILD_SQ_SCANNER_HOME = tool name: 'sonarscanner', type: 'hudson.plugins.sonar.MsBuildSQRunnerInstallation';
             ...
             withSonarQubeEnv('SonarQube') {
                 dir("Source/${config.projectName}") {
                   ...
                   sh ("""${scannerHome}/bin/sonar-scanner begin -D /k:AosoDevops -D /d:sonar.host.url=http://192.168.1.23:9000" -D /d:sonar.login="23b5d4c1c1f76c539f1d0019945228a4003d6a51""")
